...
?>
				<div class="box-danger box-solid">
					...
					<div class="box-body">
						<a class='btn  btn-danger' href='?module=admin&act=tambahadmin'>Tambah Administrator </a>
						<br><br>
						<table id="example1" class="table table-bordered table-striped">
							...
							<tbody>
								...
								while ($r = mysql_fetch_array($tampil_admin)) {
									...
									<td>
										<center>
											<a href='?module=admin&act=editadmin&id=$r[id_session]' title='Edit' class='btn btn-danger'>Edit</a>
										</center>
									</td>
									</tr>";
									$no++;
		...
		case "detailpengajar":
          ...
          <tr><td rowspan='13'>";
				...
				echo "</td><td>Kode Dosen</td>  <td> : $r[kodedosen]</td><tr>
