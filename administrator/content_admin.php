...
?>
    ...
    <div class="box-header with-border">
      <h3 class="box-title"><i class="fa fa-tag"></i> Quick Access</h3>
    </div>
    <div class="box-body">
      <div class="row">
        <div class="col-md-12">
      ...
      <div class="row">
        <div class="col-lg-6 col-xs-6">
          ...
          <div class="small-box bg-red">
            ...
            <a href="?module=siswa" class="small-box-footer">Pilih <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div><!-- ./col -->
        ...
        <div class="col-lg-6 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              ...
              <h3>Pembobotan Kriteria</h3>
            </div>
            <div class="icon">
              <i class="fa fas fa-balance-scale"></i>
            </div>
            <a href="?module=matapelajaran" class="small-box-footer">Pilih <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div><!-- ./col -->
        ...
        <div class="col-lg-6 col-xs-6">
          ...
          <div class="small-box bg-red">
            ...
            <a href="?module=matapelajaran&act=himpunankriteria" class="small-box-footer">Pilih <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div><!-- ./col -->
        ...
        <div class="col-lg-6 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <?php $kriteria = mysql_num_rows(mysql_query("SELECT * FROM siswa")); ?>
              <h3>8</h3>
            ...
            <a href="?module=matapelajaran&act=klasifikasi" class="small-box-footer">Pilih <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div><!-- ./col -->
